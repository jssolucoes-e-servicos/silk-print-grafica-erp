            ...
            <div className="flex items-center gap-2">
              <div className="relative flex-1">
                ...
                <select
                  ...
                  className="w-full pl-9 pr-3 py-2 text-xs bg-zinc-950 border border-zinc-800 rounded-lg text-zinc-200 focus:outline-hidden focus:border-amber-500 focus:ring-1 focus:ring-amber-500"
                >
              ...
              <button
                ...
                className="p-2 bg-amber-500 hover:bg-amber-400 text-zinc-950 rounded-lg transition-colors font-bold shrink-0 shadow-sm"
          ...
          <div className="p-5 rounded-xl bg-zinc-900/90 border border-zinc-800 shadow-md space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="px-3.5 py-1.5 rounded-lg bg-amber-500 hover:bg-amber-400 text-zinc-950 text-xs font-bold transition-all shadow-sm flex items-center gap-1.5"
              >
                  ...
                  >
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] uppercase font-bold text-amber-400 bg-amber-500/10 px-1.5 rounded">
                          {item.sourceTab}
                        </span>
                      </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="w-24">
                  <input
                    ...
                    placeholder="0,00"
                    className="w-full px-2 py-1 text-right text-xs bg-zinc-950 border border-zinc-800 rounded text-zinc-200 font-mono focus:outline-hidden focus:border-amber-500"
                  />
                </div>
              </div>

                ...
                {filtered.map((tx) => (
                  ...
                  >
                    <td className="py-3.5 px-4">
                      ...
                      {tx.clientName && (
                        <div className="text-[10px] text-zinc-400">Cliente: {tx.clientName}</div>
                      )}
                    </td>
                    <td className="py-3.5 px-4 text-zinc-400">{tx.paymentMethod || '—'}</td>
                    ...
                    <td className="py-3.5 px-4 text-right" onClick={(e) => e.stopPropagation()}>
                      <button
                        onClick={() => onOpenTransactionDetails?.(tx)}
                        className="px-2.5 py-1 bg-zinc-800 hover:bg-blue-600 hover:text-white text-zinc-300 text-[11px] font-semibold rounded-lg transition-colors inline-flex items-center gap-1"
                      >
